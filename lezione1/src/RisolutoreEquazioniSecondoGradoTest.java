...
class RisolutoreEquazioniSecondoGradoTest {
    ...
    final void testSolve() {
        ...
        Assertions.assertTrue(s1.isEmptySolution());
        ...
        Assertions.assertFalse(s2.isEmptySolution());
        Assertions.assertFalse(s2.isOneSolution());
        // non so l'ordine in cui vengono date le soluzioni, quindi provo
        // entrambe le possibilità
        Assertions.assertTrue(s2.getS1() == 1 || s2.getS1() == 2); // rischioso usare ==
        Assertions.assertTrue(s2.getS2() == 1 || s2.getS2() == 2); // rischioso usare ==
        ...
        Assertions.assertFalse(s3.isEmptySolution());
        Assertions.assertTrue(s3.isOneSolution());
        Assertions.assertTrue(Math.abs(s3.getS1() - 1) < EPSILON);
