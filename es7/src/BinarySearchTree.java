...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    protected class RecBST {
        ...
        protected int computeHeight() {
            /*
             * Se questo nodo è una foglia, la sua altezza è 0
             */
            if (this.left == null && this.right == null) {
                return 0;
            }
            /*
             * Altrimenti, la sua altezza è 1 più grande dell'altezza del
             * sottoalbero più alto
             */
            else {
                int leftHeight = 0;
                int rightHeight = 0;
                if (this.left != null) leftHeight = this.left.computeHeight();
                if (this.right != null) rightHeight = this.right.computeHeight();
        ...
        protected boolean insert(E label) {
            ...
            if (this.left == null && this.right == null) {
                // se l'etichetta è minore di quella del nodo corrente, aggiunge
                // il nodo a sinistra
                if (label.compareTo(this.label) < 0) {
                    this.left = new RecBST(label, null, null, this);
                    return true;
                    // se l'etichetta è maggiore di quella del nodo corrente,
                    // aggiunge il nodo a destra
                } else if (label.compareTo(this.label) > 0) {
                    this.right = new RecBST(label, null, null, this);
                    return true;
                    // se l'etichetta è uguale a quella del nodo corrente, non
                    // aggiunge nulla
                } else {
                    return false;
                }
                ...
                // se l'etichetta è minore di quella del nodo corrente, chiama
                // il metodo sull'albero sinistro
                if (label.compareTo(this.label) < 0) {
                    if (this.left == null) {
                        this.left = new RecBST(label, null, null, this);
                        return true;
                    ...
                    // se l'etichetta è maggiore di quella del nodo corrente,
                    // chiama il metodo sull'albero destro
                } else if (label.compareTo(this.label) > 0) {
                    if (this.right == null) {
                        this.right = new RecBST(label, null, null, this);
                        return true;
        ...
        /*
         * Aggiunge a una lista data le etichette dei nodi di questo
        ...
        protected void addLabelsInOrder(List<E> l) {
            /*
             * caso base: nodo foglia
             * aggiunge l'etichetta del nodo corrente alla lista
             */
            if (this.left == null && this.right == null) {
                l.add(this.label);
                /*
                 * caso ricorsivo: nodo interno
                 * aggiunge le etichette dei sotto alberi sinistro e destro
                 */
            } else {
                if (this.left != null) {
        ...
        protected List<E> inOrderVisit() {
            ...
            if (this.left == null && this.right == null) {
                ...
                if (this.left != null) {
                    l.addAll(this.left.inOrderVisit());
                }
                l.add(this.label);
                if (this.right != null) {
        ...
        protected RecBST getMinNode() {
            ...
            if (this.left == null) {
                ...
                /*
                 * caso ricorsivo: nodo interno
                 * restituisce il nodo più a sinistra che non ha un sotto-albero
                 * sinistro
                 */
            } else {
        ...
        protected RecBST getMaxNode() {
            ...
            if (this.right == null) {
                ...
                /*
                 * caso ricorsivo: nodo interno
                 * restituisce il nodo più a destra che non ha un sotto-albero
                 * destro
                 */
            } else {
        ...
        protected void deleteSelfLabel() {
            /*
             * caso base: nodo foglia
             * cancella il nodo corrente
             */
            if (this.left == null && this.right == null) {
                this.parent = null;
                /*
                 * caso ricorsivo: nodo interno
                 * cancella il nodo corrente copiando l'etichetta del nodo
                 * successore
                 */
            } else {
