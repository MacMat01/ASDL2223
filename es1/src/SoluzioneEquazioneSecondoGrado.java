...
public class SoluzioneEquazioneSecondoGrado {
    ...
    public SoluzioneEquazioneSecondoGrado(EquazioneSecondoGrado e) {
        if (e == null) throw new NullPointerException("Tentativo di creare una soluzione di una equazione nulla");
        this.e = e;
     ...
     * @throws NullPointerException se l'equazione passata è nulla
     */
    public SoluzioneEquazioneSecondoGrado(EquazioneSecondoGrado e, double s1, double s2) {
        if (e == null) throw new NullPointerException("Tentativo di creare una soluzione di una equazione nulla");
        this.e = e;
        this.emptySolution = false;
        this.oneSolution = false;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SoluzioneEquazioneSecondoGrado)) return false;
        ...
        if (emptySolution != other.emptySolution) return false;
        if (oneSolution != other.oneSolution) return false;
        if (Double.doubleToLongBits(s1) != Double.doubleToLongBits(other.s1)) return false;
        if (Double.doubleToLongBits(s2) != Double.doubleToLongBits(other.s2)) return false;
        return true;
    }
    ...
    public String toString() {
        ...
        s.append("=== Soluzione di Equazione di Secondo Grado ===\nEquazione originale: " + e.toString() + "\n");
        if (this.isEmptySolution()) s.append("Soluzione vuota.");
        else if (this.isOneSolution()) s.append("Due soluzioni coincidenti: " + s1);
        else s.append("Prima soluzione: " + s1 + "\n" + "Seconda soluzione: " + s2);
        s.append("\n=== Fine Soluzione ===");
        return s.toString();
    }
