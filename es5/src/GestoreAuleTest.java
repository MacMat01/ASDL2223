...
class GestoreAuleTest {
    ...
    final void testCercaAuleLibere() {
        ...
        TimeSlot requestedTimeSlot = new TimeSlot(new GregorianCalendar(2019, 10, 4, 11, 0), new GregorianCalendar(2019, 10, 4, 13, 0));
        assertThrows(NullPointerException.class, () -> g.cercaAuleLibere(requestedFacilities, null));
        assertThrows(NullPointerException.class, () -> g.cercaAuleLibere(null, requestedTimeSlot));
        assertThrows(NullPointerException.class, () -> g.cercaAuleLibere(null, null));
        ...
        a.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 4, 9, 0), new GregorianCalendar(2019, 10, 4, 11, 5)), "LT", "");
        a.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 3, 11, 0), new GregorianCalendar(2019, 10, 3, 13, 0)), "LT", "");
        a.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 4, 15, 0), new GregorianCalendar(2019, 10, 4, 18, 0)), "LT", "");
        assertTrue(g.addAula(a));
        Aula aa = new Aula("AA1", "Polo Lodovici Piano Terra");
        ...
        aa.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 4, 9, 0), new GregorianCalendar(2019, 10, 4, 11, 5)), "LT", "");
        aa.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 3, 11, 0), new GregorianCalendar(2019, 10, 3, 13, 0)), "LT", "");
        aa.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 4, 15, 0), new GregorianCalendar(2019, 10, 4, 18, 0)), "LT", "");
        assertTrue(g.addAula(aa));
        ...
        b.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 4, 9, 0), new GregorianCalendar(2019, 10, 4, 11, 5)), "LT", "");
        b.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 3, 11, 0), new GregorianCalendar(2019, 10, 3, 13, 0)), "LT", "");
        b.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 4, 15, 0), new GregorianCalendar(2019, 10, 4, 18, 0)), "LT", "");
        assertTrue(g.addAula(b));
        ...
        c.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 4, 9, 0), new GregorianCalendar(2019, 10, 4, 12, 30)), "LT", "");
        c.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 3, 11, 0), new GregorianCalendar(2019, 10, 3, 13, 0)), "LT", "");
        c.addPrenotazione(new TimeSlot(new GregorianCalendar(2019, 10, 4, 15, 0), new GregorianCalendar(2019, 10, 4, 18, 0)), "LT", "");
