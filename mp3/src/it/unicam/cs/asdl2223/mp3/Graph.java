...
public abstract class Graph<L> {
     ...
     * @return true se l'arco è stato inserito, false se un arco esattamente
     * uguale già esiste
     * @throws NullPointerException     se una delle etichette passate è
     *                                  nulla
     ...
     * @throws IllegalArgumentException      se l'arco non esiste in questo
     *                                       grafo
     * @throws IllegalArgumentException      se almeno uno dei due nodi
     ...
     * @throws IllegalArgumentException      se almeno uno dei due nodi
     *                                       passati non esiste
     * @throws NullPointerException          se almeno uno dei due nodi
     *                                       passati è nullo
     * @throws UnsupportedOperationException se l'implementazione del grafo
     *                                       non supporta questa operazione
     */
     ...
     *                                       nel grafo
     * @throws NullPointerException          se almeno una deelle due
     ...
     * @throws IllegalArgumentException se almeno uno dei due nodi dell'arco
     ...
     * qualsiasi ordine
     * @throws NullPointerException     se almeno una delle due etichette
     *                                  passate è null
     * @throws IllegalArgumentException se almeno una delle due etichette
     ...
     * gli archi uscenti.
     *
     * @param label l'etichetta del nodo di cui sono richiesti gli archi
     *              connessi
     ...
     * grafo orientato)
     * @throws IllegalArgumentException se il nodo con l'etichetta passata
     *                                  non esiste
     * @throws NullPointerException     se l'etichetta passata è nulla
     */
     ...
     * Questa operazione è opzionale.
     *
     * @param label l'indice del nodo di cui sono richiesti gli archi
     *              connessi
     ...
     * Questa operazione è opzionale.
     *
     * @param label l'etichetta del nodo di cui determinare tutti gli archi
     *              entranti
     ...
     * Questa operazione è opzionale.
     *
     * @param i l'indice del nodo di cui determinare tutti gli archi
     *          entranti
     * @return un insieme contenente tutti gli archi entranti nel nodo con
